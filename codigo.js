...
var ptsB=document.getElementById("ptsJ1");
var ptsN=document.getElementById("ptsJ2");
var troB=document.getElementById("infB");
var troN=document.getElementById("infN");
var blancas=12;
var negras=12;
var marca;
var dibuja;
...
//Iniciar
	...
	stard.addEventListener("mouseover",function(){
		stard.style.backgroundColor="yellow";
	},false);
	stard.addEventListener("mouseout",function(){
		stard.style.backgroundColor="";
	},false);
...
//Funciones
	...
	function puntos(ptoc){
		if(ptoc==1){
			var div=document.createElement("div");
			div.className="puntoB";
			ptsN.appendChild(div);
		}
		else if(ptoc==0){
			var div=document.createElement("div");
			div.className="puntoN";
			ptsB.appendChild(div);
		}
		else if(ptoc==4){
			var div=document.createElement("div");
			div.className="puntoRN";
			ptsB.appendChild(div);
		}
		else if(ptoc==3){
			var div=document.createElement("div");
			div.className="puntoRB";
			ptsN.appendChild(div);
		}
	}
	...
	function fturno2(){
		troc=parseInt(dibuja.getAttribute("f"));
		if((troc==0 || troc==3)){
			troB.style.borderColor="black";
			troN.style.borderColor="#39ff14";
			return true;
		}
		else if((troc==1 || troc==4)){
			troN.style.borderColor="white";
			troB.style.borderColor="#39ff14";			
			return true;
		}
	}
